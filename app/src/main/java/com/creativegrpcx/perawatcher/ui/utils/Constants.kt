...
object Constants {
    ...
    fun categoryIcon(categoryType: CategoryType): Int {
        return when (categoryType) {
            CategoryType.Appliances -> R.drawable.baseline_coffee_maker_24
            CategoryType.BeautyAndPersonalCare -> R.drawable.baseline_face_24
            CategoryType.Bills -> R.drawable.baseline_receipt_24
            CategoryType.Electronics -> R.drawable.outline_computer_24
            CategoryType.Food -> R.drawable.baseline_local_grocery_store_24
            ...
            CategoryType.Hobbies -> R.drawable.baseline_sports_esports_24
            CategoryType.PetSupplies -> R.drawable.outline_pets_24
            CategoryType.Subscriptions -> R.drawable.baseline_subscriptions_24
