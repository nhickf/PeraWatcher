...
class GlobalViewModel @Inject constructor(
    ...
    private val _uiStateRoute = MutableStateFlow(Constants.ScreenRoutes)
    ...
    fun updateCurrentRoute(newRoute: ScreenRoute) {
        Log.e("updateCurrentRoute", "$newRoute")
        _uiStateRoute.value = Constants.ScreenRoutes.toMutableList().map {
            it.apply {
                isSelected = it == newRoute
            }
        }
    }
